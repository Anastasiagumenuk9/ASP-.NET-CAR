...
namespace BAL.Managers
{
    public class TokenAuthenticationManager : IAuthenticateManager
    {
      ...
      public TokenAuthenticationManager(Microsoft.AspNetCore.Identity.UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager,IOptions<TokenManagement> tokenManagement)
     {
