...
namespace BAL.Managers
{
    public class TokenAuthenticationManager : IAuthenticateManager
    {
        ...
        public TokenAuthenticationManager(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager,/*IUserManagementService service, */IOptions<TokenManagement> tokenManagement)
        {
